...
@Component({
  selector: 'app-editor-track-change',
  templateUrl: './editor-track-change.component.html',
  styleUrls: ['./editor-track-change.component.css']
})
export class EditorTrackChangeComponent implements AfterViewInit, OnDestroy {
	...
	public get editorConfig() {
		return {
			...
			//exportPdf:testing(this.appData),
			sidebar: {
...
function testing (appData:any){
	 const exportPdfConfig = {
		dataCallback: ( editor: Editor ) => {
			console.log("Line 3111 ");
			return `
