...
export function getRevisionHistoryAdapter( appData ) {
	return class RevisionHistoryAdapter {
		...
		public async init() {
			...
			const exportPdf = this.editor.plugins.get( 'ExportPdf' ) as ExportPdf;
			...
			revisionHistory.adapter = {
				...
				getRevision: ( { revisionId } ) => {
					console.log("in the beginning of Get Revisioning ")
				...
				updateRevisions: ( revisionsData: any, channelId: string ): Promise<any> => {
					...
					console.log( 'Revisions updated diffData: ', revisionsData.diffData );
					console.log( 'Revisions updated attributes: ', revisionsData.attributes);
