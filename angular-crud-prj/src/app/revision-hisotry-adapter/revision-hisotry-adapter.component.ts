...
@Component({
  selector: 'app-revision-hisotry-adapter',
  templateUrl: './revision-hisotry-adapter.component.html',
  styleUrls: ['./revision-hisotry-adapter.component.css']
})
export class RevisionHisotryAdapterComponent implements AfterViewInit, OnDestroy {
